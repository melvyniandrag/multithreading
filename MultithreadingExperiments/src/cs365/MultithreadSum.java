...
public class MultithreadSum extends Thread{
	...
	private static void computeSum(List<Integer> numbers) throws InterruptedException{
		...
		Thread t1 = new Thread(new MultithreadSum(numbers, batchSize*0, batchSize));
		Thread t2 = new Thread(new MultithreadSum(numbers, batchSize*1, batchSize));
		Thread t3 = new Thread(new MultithreadSum(numbers, batchSize*2, batchSize));
		Thread t4 = new Thread(new MultithreadSum(numbers, batchSize*3, batchSize));
